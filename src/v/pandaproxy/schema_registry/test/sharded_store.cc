...
SEASTAR_THREAD_TEST_CASE(test_sharded_store_global_compat) {
    ...
    BOOST_REQUIRE(
      store.get_compatibility(pps::default_context, pps::default_to_global::no).get() == expected);
...
SEASTAR_THREAD_TEST_CASE(test_sharded_store_subject_compat) {
    ...
    BOOST_REQUIRE(
      store.get_compatibility(pps::default_context, pps::default_to_global::no).get() == global_expected);
...
SEASTAR_THREAD_TEST_CASE(
  test_sharded_store_default_context_config_no_fallback) {
    ...
    BOOST_REQUIRE(
      store.get_compatibility(pps::default_context, no_fallback).get() == expected);
...
SEASTAR_THREAD_TEST_CASE(test_sharded_store_default_context_config_fallback) {
    ...
    BOOST_REQUIRE(
      store.get_compatibility(pps::default_context, fallback).get() == expected1);
    ...
    BOOST_REQUIRE(
      store.get_compatibility(pps::default_context, fallback).get() == expected2);
...
SEASTAR_THREAD_TEST_CASE(
  test_sharded_store_nondefault_context_config_no_fallback) {
    ...
    BOOST_REQUIRE(
      store.get_compatibility(ctx, no_fallback).get() == expected);
  ...
  test_sharded_store_nondefault_context_config_fallback) {
    ...
    BOOST_REQUIRE(
      store
        ...
        .get());
    BOOST_REQUIRE(
      store.get_compatibility(ctx, fallback).get() == expected1);
    ...
    BOOST_REQUIRE(
      store
        ...
        .get());
    BOOST_REQUIRE(
      store.get_compatibility(ctx, fallback).get() == expected2);
