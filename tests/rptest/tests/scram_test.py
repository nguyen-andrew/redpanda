...
SCRAM_MECHANISM_MAP = {
    ...
    "SCRAM-SHA-256": security_pb2.ScramCredential.SCRAM_MECHANISM_SCRAM_SHA_256,
    "SCRAM-SHA-512": security_pb2.ScramCredential.SCRAM_MECHANISM_SCRAM_SHA_512,
}
...
class BaseScramTest(RedpandaTest):
    ...
    def update_scram_credential_v2(
        ...
        mechanism: security_pb2.ScramCredential.ScramMechanism = security_pb2.ScramCredential.SCRAM_MECHANISM_SCRAM_SHA_256,
    ...
    def delete_scram_credential_v2(self, name: str, quote: bool = False) -> None:
        if quote:
            name = urllib.parse.quote(name, safe="")
