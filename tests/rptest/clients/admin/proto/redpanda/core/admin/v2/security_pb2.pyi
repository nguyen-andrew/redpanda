...
class ScramCredential(google.protobuf.message.Message):
    ...
    class _ScramMechanismEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[ScramCredential._ScramMechanism.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        SCRAM_MECHANISM_UNSPECIFIED: ScramCredential._ScramMechanism.ValueType
        SCRAM_SHA_256: ScramCredential._ScramMechanism.ValueType
        SCRAM_SHA_512: ScramCredential._ScramMechanism.ValueType

    class ScramMechanism(_ScramMechanism, metaclass=_ScramMechanismEnumTypeWrapper):
        """The SCRAM mechanism."""
    SCRAM_MECHANISM_UNSPECIFIED: ScramCredential.ScramMechanism.ValueType
    SCRAM_SHA_256: ScramCredential.ScramMechanism.ValueType
    SCRAM_SHA_512: ScramCredential.ScramMechanism.ValueType
    ...
    mechanism: Global___ScramCredential.ScramMechanism.ValueType
    ...
    def created_at(self) -> google.protobuf.timestamp_pb2.Timestamp:
        """The timestamp when the SCRAM credential was created."""

    def __init__(self, *, name: builtins.str=..., mechanism: Global___ScramCredential.ScramMechanism.ValueType=..., password: builtins.str=..., created_at: google.protobuf.timestamp_pb2.Timestamp | None=...) -> None:
        ...

    def HasField(self, field_name: typing.Literal['created_at', b'created_at']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing.Literal['created_at', b'created_at', 'mechanism', b'mechanism', 'name', b'name', 'password', b'password']) -> None:
        ...
